...
const meta = {
  ...
  description:
    "Review the Terms of Service for DeVeSheDreams. Understand the guidelines, policies, and conditions that apply when using our website and purchasing our handcrafted fashion collections.",
  keywords: [
    "DeVeSheDreams terms",
    "terms of service",
    "policies",
  ...
  og: {
    title: "Terms of Service – DeVeSheDreams",
    description:
      "Read the Terms of Service to understand the policies and conditions for using the DeVeSheDreams website and purchasing our artistic fashion pieces.",
  },
  twitter: {
    card: "summary_large_image",
    title: "Terms of Service – DeVeSheDreams",
    description:
      "Learn about the Terms of Service and policies that guide your experience with DeVeSheDreams.",
  },
};
  ...
  return (
    <div id="legal-page">
      ...
      <div className="legal-container">
        <p>By using our website ("Service"), you agree to the following terms:</p>
        <p>
