    ...
    <>
      ...
      <div id="legal-page">
        ...
        <div className="legal-container">
          <p>
            [DeVeSheDreams] ("we" or "us") values your privacy and is committed
          ...
          <p>
            This website is operated by Deveshi Sandip Jhunjhunwala, sole
            proprietor of DeVeSheDreams.
          </p>
          <p>
            For any questions regarding this policy, you may contact us at{" "}
            <a target="_blank" href="mailto:deveshedreams@gmail.com">
          ...
          <p>
            ...
            (2)First name and last name (3) Phone number (4) Address (5) State
            or province (6) ZIP/Postal code (7) City
          </p>
          <p>
