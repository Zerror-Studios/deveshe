  ...
  return (
    <div id="legal-page">
      ...
      <div className="legal-container">
        ...
        <h4>How long will it take to deliver my order (domestic and international)?</h4>
        <ul>
        ...
        <h4>For all international orders, shipping duration depends from country to country. How can I track my order?</h4>
        ...
        <h4>Terms Of The Exchange Policy:</h4>
        <ul>
        ...
        <h4>Procedure For Product Returns & Exchange:</h4>
        <ul>
