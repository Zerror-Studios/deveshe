...
const ReviewSection = () => {
  ...
  const reviews = [
  {
    ...
    content: "I love the blue ombré top I got! It’s so comfortable and fits so well! I love the silver detailing on the sleeves too, just the right amount of accent needed to elevate the top!",
    time: "1:21 PM",
    date: "Aug 26, 2025",
  ...
  },
  {
    ...
    content: "The designs for each piece feel thoughtful and unique while maintaining consistent quality. Great statement pieces to add to any wardrobe!",
    time: "1:21 PM",
    date: "Aug 26, 2025",
    tag: "De Ve She Dreams",
  },
  {
    ...
    avatar: "/assets/images/home/home_banner.webp",
    content: "I bought this printed poplin shirt for my son and he absolutely loves it. It’s comfortable and looks great on him.",
    time: "1:21 PM",
    date: "Aug 26, 2025",
    tag: "De Ve She Dreams",
  },
  {
    ...
    handle: "@arujakothari",
    avatar: "/assets/images/home/home_banner.webp",
    content: "The collection at De Ve She Dreams is super versatile! Love the way they use motifs along with abstract patterns. The fabric is so comfortable and you can easily style the pieces up or down! 100% recommended 😍",
    time: "1:21 PM",
    date: "Aug 26, 2025",
    tag: "De Ve She Dreams",
  },
          ...
          <div className="tweet-card" role="article" aria-label="Tweet card">
            ...
            <div className="tweet-header">
              ...
              <div className="author">
                ...
                {review.handle && <div className="handle">{review.handle}</div>}
              </div>
            ...
            {review.time && review.date && (
              <div className="tweet-footer">
                ...
                {review.tag && (
                  <>
                    <span>·</span>
                    <a href="#" className="tag">{review.tag}</a>
                  </>
                )}
              </div>
            )}
