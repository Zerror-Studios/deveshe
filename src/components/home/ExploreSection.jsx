  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap
        .timeline({
          scrollTrigger: {
            trigger: ".explore_inspired_container",
            start: "top 70%",
            end: "top 20%",
          },
        })
   ...
   const handleScrollTo = () => {
    if (sectionRef.current) {
      sectionRef.current.scrollIntoView({
        ...
        block: "start",     // align top of the element
        inline: "nearest",
      });
    }
  };
  ...
  return (
    <div id="explore_section">
      ...
      <div className="explore_inspired_container">
        ...
        <div onClick={handleScrollTo} onMouseEnter={enterHandler} className="explore_inspired_button">
          [
