        ...
        <div className="add-payment-main">
          <div className="wrap-payment-head">
            <div className="detail-top">
              ...
              <div className="icons-pay">
                <img src="./visa.svg" className="master2"></img>
                <img src="./mastercard.svg" className="master"></img>
                <img src="./payment.svg" className="master"></img>
              </div>
            </div>
          ...
          <div className="card-details">
            ...
            <div className="twoinone2">
              ...
              <div className="div-name card-info">
                <label className="label-text text-sm font-bold">CVV</label>
                <input
                  className="general__input"
                  type="number"
                  placeholder="XXX"
            ...
            <div className="text-pay f-2">
              <input type="checkbox" className="checkbox" />
              <div>
                I'm legally authorized to save this payment method on my team
                account, and to allow current and future teammates with billing
                permissions to use it.
              </div>
            </div>

            {/* Invoice */}
            <div className="detail-top" style={{ marginTop: "15px" }}>
              <p>Invoice details</p>
            </div>
            ...
            <div className="div-name card-info">
              <label className="label-text text-sm font-bold">Address</label>
              <input
                className="general__input"
                type="text"
                placeholder="Address"
