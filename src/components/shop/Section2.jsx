...
const Section2 = () => {
  ...
  useGSAP(() => {
    ...
    tl.fromTo('#title-main-wrap3 h2 span', {
    ...
    // btn hover animation
    document.querySelector("#btn-text-wrap").addEventListener("mouseenter", (e) => {
      gsap.fromTo(".text1-btn span", {
        y: "0%",
      }, {
        duration: .5,
        y: "-100%",
      ...
      <div className={styles.shopSection2Bottom} id='section2-bottom-shop'>
        ...
        <div className={styles.shopSection2BottomBtn}>
          ...
          <div className={styles.shopSection2BottomBtnText} id='btn-text-wrap'>
            <h4>Take the Quiz</h4>
            <h4 className='text1-btn'>Take the Quiz</h4>
            <h4 className='text2-btn'>Take the Quiz</h4>
          </div>
          ]
        </div>
